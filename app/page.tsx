        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Powered by GPT-4 & RAG</p>
            </div>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center p-6">
            ...
            <p className="text-gray-600 text-sm">
              Uses RAG to retrieve relevant information from my profile and
          ...
          <div className="text-center p-6">
            ...
            <p className="text-gray-600 text-sm">
              Interested recruiters can easily share their contact information
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-600">
              © 2024 AI Portfolio Assistant. Built with Next.js, TypeScript,
              OpenAI, and MongoDB.
            </p>
